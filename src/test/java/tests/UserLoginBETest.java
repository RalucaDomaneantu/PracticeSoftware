...
public class UserLoginBETest extends SharedData {
    ...
    public void userTest() {
        ...
        RequestUserModel requestBody = new RequestUserModel("Ralu", "Stoica", addressModel, "0987654321", "1970-01-01", "SuperSecure@123", "test1234@gmail.com");

        UserService userService = new UserService();
        ResponseUserModel responseBody = userService.createUser(requestBody);

        //Inseram datele in baza de data in tabelul user
